...
$domandeRiposte = [
    "domanda1" => [
            "title" => "Come state implementando la recente decisione della Corte dl giustizia dell'Unione europea (CGUE) relativa al diritto all'oblio?",
            "text" => [
    ...
    "domanda4" => [
        "title" => "Quando faccio clic sul risultati della Ricerca Google, le mie chiavi di ricerca vengono inviate ai siti web? ",
...
<body>
    <nav>
        <div class="logo">
            <img src="https://cdn.pixabay.com/photo/2015/11/02/14/01/google-1018443_960_720.png" alt="">
    ...
    <div class="container">
        <?php foreach($domandeRiposte as $key => $value) : ?>
            <h2><?php echo $value["title"]; ?></h2>
            <?php foreach($value["text"] as $element) : ?>
